...
export const PricingTable = ({ className }: PricingTableProps) => {
  const features = [
    ...
    { name: "Shopify product sync", free: "Weekly", starter: "Daily", pro: "Hourly" },
    { name: "ChatGPT Shopping optimization", free: "1/day (~30/mo)", starter: "20/day (~600/mo)", pro: "Unlimited" },
    { name: "ACP feed for Shopify", free: true, starter: true, pro: true },
    ...
    { name: "Product performance insights", free: false, starter: "Summary", pro: "Full detail + graph" },
    ...
    { name: "Backlinks from AgentRanked", free: false, starter: false, pro: "Priority placement" },
